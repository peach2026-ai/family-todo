...
请根据以下未完成的家庭任务，生成3条简短建议：

${taskSummary}

要求：
1. 建议的对象只能是强哥和桃子，用"你们""强哥""桃子"来称呼
2. 小宝是婴儿，不要说"提醒小宝"之类的话，涉及小宝的任务直接提醒强哥桃子去做，比如"记得给小宝喂奶""该带小宝去体检了"
3. 长辈的任务，用"记得叮嘱外公…"的方式提醒强哥桃子
4. 语气温馨亲切，像闺蜜/好兄弟一样关心他们
5. 重点提醒高优先级任务，不要让人焦虑但要有行动感
6. 每条建议独占一行，用emoji让内容更生动
7. 直接输出建议内容，不要加标题、编号或多余格式`;
}
